...
if(location.pathname.includes('mariage')){
  ...
  if(mariageHero){
    ...
    style.textContent=`
      ...
      @media(max-width:700px){.mariage-hero-live{min-height:520px!important;padding:58px 24px!important;background-position:58% center!important;background-image:linear-gradient(90deg,rgba(25,20,17,.66),rgba(25,20,17,.22)),url('assets/mariage-plage.jpeg?v=20260908-0130')!important}.mariage-hero-live h1{font-size:clamp(2.9rem,14vw,4.5rem)!important;max-width:90%!important}.mariage-hero-live>p:last-child{font-size:1.2rem!important;max-width:88%!important}}
    `;
